...
extension NPC {
    ...
    static func replySchema(persona: Persona, options: NPCOptions) -> JSONSchema {
        ...
        var properties: [(String, JSONValue)] = [
            ("emotion", JSONSchema.string(description: "How \(persona.name) feels right now, given their personality and what the player just said. Use neutral only when no feeling fits.", enum: emotions).json),
